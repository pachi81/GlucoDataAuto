...
- if these settings are grayed out, enable `Notification with Assistant` first
...
-> [Source configuration instruction](https://github.com/pachi81/GlucoDataHandler/wiki/Sensors)
